...
let firstLast = people.map(person => {
  const [last, first] = person.split(', ');  // Split the string into last and first name
  return `${first} ${last}`;  // Reformat as "First Last"
});
...
// Check your work:
console.log('Exercise 6 my result: ', isAdultPresent); // Should output true
...
let dev = [
  { name: 'John', year: 2005 },
  { name: 'Sarah', year: 2000 },
  { name: 'Tom', year: 2007 },
  { name: 'Emma', year: 2003 }
];

let currentYear = new Date().getFullYear();
let isEveryone19OrOlder = dev.every(dev => currentYear - dev.year >= 19);

// Check your work:
console.log('Exercise 7 my result: ', isEveryone19OrOlder); // Should output false
...
let comments = [
  { text: 'Nice post!', id: 12345 },
  { text: 'Super good', id: 823423 },
  { text: 'Great read', id: 54321 }
];

let commentById = comments.find(comment => comment.id === 823423);

// Check your work:
console.log('Exercise 8 my result: ', commentById); // Should output: { text: 'Super good', id: 823423 }
